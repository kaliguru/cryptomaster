...
(5, 'Staking Invest', 'staking_invest', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"staking\"]', NULL, 1, '2023-07-26 18:55:58', '2023-07-26 18:50:58', 1, 1, '2023-06-22 12:10:31', '2023-07-26 18:50:58');
...
CREATE TABLE `general_settings` (
  ...
  `firebase_template` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `push_notify` tinyint(1) NOT NULL DEFAULT '0',
  `off_day` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `last_cron` datetime DEFAULT NULL,
  `b_transfer` int NOT NULL DEFAULT '0' COMMENT 'Balance Transfer Status',
  ...
  `language_switch` tinyint UNSIGNED NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `invests` (
  ...
  `hours` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `time_name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `trx` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `wallet_type` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `plans` (
  `id` bigint UNSIGNED NOT NULL,
  `time_setting_id` int NOT NULL DEFAULT '0',
  ...
  `repeat_time` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `transactions` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` int UNSIGNED NOT NULL DEFAULT '0',
  `invest_id` int NOT NULL DEFAULT '0',
  `amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `charge` decimal(28,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE `users` (
  ...
  `user_ranking_id` int NOT NULL DEFAULT '0',
...
CREATE TABLE `user_rankings` (
  ...
  `min_referral` int NOT NULL DEFAULT '0',
